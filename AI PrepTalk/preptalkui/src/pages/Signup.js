...
export default function Signup() {
  ...
  const [serverMessage, setServerMessage] = useState(""); // For backend messages
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/signup", { // ✅ Fixed API URL
        method: "POST",
      ...
      if (response.ok) {
        ...
        setForm({ fullName: "", email: "", password: "", confirmPassword: "" }); // ✅ Clear form
